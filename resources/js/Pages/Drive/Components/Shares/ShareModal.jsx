...
const ShareModal = ({
    ...
    return (
        <Modal
            ...
            title={`Share ${selectedFiles.size} files`}
            classes="max-w-md "
        >
                ...
                <div className="text-sm flex flex-col text-gray-300/80">
                    <div className="mb-5">
                        <p className="text-gray-300 text-lg mt-3">
                            Generate a link to share selected files. Recommended
                            to share only with trusted people.
                        </p>
                    </div>
                    <ul className="mb-5">
                        <li>
                            <span className=" font-semibold text-gray-300/80 text-base">
                                Password
                            </span>
                            : Highly recommended
                        </li>
                        <li>
                            ...
                            : Days after which link will be invalid
                        </li>
                        <li>
                            <span className=" font-semibold text-gray-300/80 text-base">
                                Custom Url{" "}
                            </span>
                            : If this is empty a random path will be generated
                        </li>
                    </ul>
